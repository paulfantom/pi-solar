...
const uint8_t EE_HEAT_ON  = 15; // (16b) Basic Central Heating schedule ON
const uint8_t EE_HEAT_OFF = 17; // (16b) Basic Central Heating schedule OFF
...
//const uint8_t EE_PUMP_HYST = 39; // (16b) Pump Hysteresis (Not used?)
...
const uint8_t EE_PID_P = 167; // (16b)  PID Proportional
const uint8_t EE_PID_I = 169; // (16b)  PID Integral
const uint8_t EE_PID_D = 171; // (16b)  PID Derivative
#endif
